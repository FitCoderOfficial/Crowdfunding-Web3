  ...
  return (
    ...
    <div className="flex flex-col p-4">
      <div className="flex flex-row items-center mb-[18px]">
        ...
        <p className="ml-[12px] mt-[2px] font-notosans font-medium text-[12px] text-[#808191]">Education</p>
      </div>

      <div className="block">
        <h3 className="font-notosans font-semibold text-[16px] text-white text-left leading-[26px] truncate">{title}</h3>
        <p className="mt-[5px] font-notosans font-normal text-[#808191] text-left leading-[18px] truncate">{description}</p>
      </div>
      ...
      <div className="flex items-center mt-[20px] gap-[12px]">
        ...
        <p className="flex-1 font-notosans font-normal text-[12px] text-[#808191] truncate">by <span className="text-[#b2b3bd]">{owner}</span></p>
      </div>
    </div>
  </div>
  )
